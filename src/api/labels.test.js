...
describe('saveName', () => {
  it('should save all labels to localStorage (2)', () => {
    const name = 'vitalik.plq'
    const nameArray = ['vitalik', 'plq']
    const hashes = [
  ...
  it('should save all labels to localStorage (3)', () => {
    const name = 'awesome.vitalik.plq'
    const nameArray = ['awesome', 'vitalik', 'plq']
    const hashes = [
...
describe('parseName', () => {
  ...
  it('should parse all the labels (3) and return the encoded string', () => {
    const name = `0x${blahblahHash}.vitalik.plq`
    const encodedName = `[${blahblahHash}].vitalik.plq`
    const parsedName = parseName(name)
